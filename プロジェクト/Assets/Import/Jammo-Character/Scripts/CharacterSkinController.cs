...
{
    Animator animator;
    [SerializeField] Renderer[] characterMaterials;

    public Material[] albedoList;
    ...
    void ChangeMaterialSettings(int index)
    {
        for (int i = 0; i < characterMaterials.Length; i++)
        {
            ...
            else
            {
                ...
                characterMaterials[i].material = albedoList[index];
            }
        }
    }
    ...
    void ChangeEyeOffset(EyePosition pos)
    {
        ...
        switch (pos)
        {
            ...
            case EyePosition.happy:
                offset = new Vector2(0.33f, 0);
                break;
            case EyePosition.angry:
                offset = new Vector2(0.66f, 0);
                break;
